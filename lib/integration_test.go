...
func TestCreateIntegration_Success(t *testing.T) {
	...
	teleflowClient := lib.NewAPIClient(teleflowApiKey, &lib.Config{BackendURL: lib.MustParseURL(httpServer.URL)})
	res, err := teleflowClient.IntegrationsApi.Create(ctx, createIntegrationRequest)
...
func TestGetAllIntegration_Success(t *testing.T) {
	...
	res, err := teleflowClient.IntegrationsApi.GetAll(ctx)
...
func TestGetActiveIntegration_Success(t *testing.T) {
	...
	res, err := teleflowClient.IntegrationsApi.GetActive(ctx)
...
func TestGetWebhookSupportStatusIntegration_Success(t *testing.T) {
	...
	res, err := teleflowClient.IntegrationsApi.GetWebhookSupportStatus(ctx, providerId)
	assert.Equal(t, response, res)
	require.NoError(t, err)
}
...
func TestUpdateIntegration_Success(t *testing.T) {
	...
	res, err := teleflowClient.IntegrationsApi.Update(ctx, integrationId, updateIntegrationRequest)
...
func TestDeleteActiveIntegration_Success(t *testing.T) {
	...
	res, err := teleflowClient.IntegrationsApi.Delete(ctx, integrationId)
...
func TestSetIntegrationAsPrimary_Success(t *testing.T) {
	...
	res, err := teleflowClient.IntegrationsApi.SetIntegrationAsPrimary(ctx, integrationId)
...
func TestGetChannelLimit_Success(t *testing.T) {
	...
	res, err := teleflowClient.IntegrationsApi.GetChannelLimit(ctx, channelType)
